        ...
        public List<Producto> Listar()
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    ...
                    sb.AppendLine("FROM PRODUCTO producto");
                    sb.AppendLine("INNER JOIN MARCA marca ON marca.IdMarca = producto.IdMarca");
                    sb.AppendLine("INNER JOIN CATEGORIA categoria ON categoria.IdCategoria = producto.IdCategoria");
                    sb.AppendLine("WHERE producto.Activo = 1");
